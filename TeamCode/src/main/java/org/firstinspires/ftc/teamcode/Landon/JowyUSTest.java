...
//public class JowyUSTest extends OpMode {
...
//    public float x, y, z, leftTrigger, rightTrigger, bpwr, fpwr;
...
//
//        fpwr = y;
//        bpwr = y; //decrease this one stoopid jowy -joey, to future joey
//
//    }
//
//    @Override
...
//
////        if(2 < distance < 10)  {  //max and minimum values for joeycode to activate
////
////        }
//
//        z = z * 1.50f;
//        frontRight.setPower( Range.clip(fpwr - x + z, -1, 1));
//        backRight.setPower(Range.clip(bpwr + x + z, -1, 1));
//        backLeft.setPower(Range.clip(bpwr - x - z, -1, 1));
//        frontLeft.setPower(Range.clip(fpwr + x - z, -1, 1));
//
