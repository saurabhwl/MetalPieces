...
//        moveRobot(0,0,0) ;
    ...
    public void moveRobot() {
        ...
        double backRightPower = driveYaw + driveAxial + driveLateral;
        double backLeftPower = driveYaw - driveAxial - driveLateral;
        double frontLeftPower = driveYaw - driveAxial - driveLateral;
        double frontRightPower = driveYaw + driveAxial - driveLateral;

        // normalize all motor speeds so no values exceeds 100%.
        double max = Math.max(Math.abs(backRightPower), Math.abs(backLeftPower));
        ...
        myOpMode.telemetry.addData("Wheels", "FR[%+5.2f], FL[%+5.2f], BR[%+5.2f], BL[%+5.2f]", frontRight, frontLeft, backRight, backLeft);
    }
