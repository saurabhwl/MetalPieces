...
public class Force_Teleop extends OpMode {
    ...
    public void loop() {
        ...
        if (myExtras.spinnyL.getCurrentPosition() > 70 && myExtras.spinnyL.getCurrentPosition() < 140) {
            offset = myExtras.spinnyL.getCurrentPosition() - 70;
            coe = offset*0.009;
        }
        else if (myExtras.spinnyL.getCurrentPosition() <= 70 && myExtras.spinnyL.getCurrentPosition() > 0) {
            offset = myExtras.spinnyL.getCurrentPosition();
            coe = offset*0.009;
        }
        else if (myExtras.spinnyL.getCurrentPosition() > 140){
            offset = (myExtras.spinnyL.getCurrentPosition()-140);
            coe = offset*0.009;
        }
        else if (myExtras.spinnyL.getCurrentPosition() < 0){
            offset = myExtras.spinnyL.getCurrentPosition();
            coe = offset*0.009;
        }
        else {
...
//        telemetry.addData("SpinnyR Target Val: ", myExtras.spinnyR.getTargetPosition());
        telemetry.addData("Coe value: ", coe);
...
//        }
        ...
        if (gamepad2.dpad_up) {
            myExtras.spinnyL.setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);
            myExtras.spinnyR.setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);
            myExtras.spinnyL.setPower(coe);
            myExtras.spinnyR.setPower(coe);
        }
...
//            myExtras.spinnyL.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
//            myExtras.spinnyR.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
...
//            myExtras.spinnyR.setTargetPosition(poe);
            ...
            coe = 0;
            myExtras.spinnyL.setPower(coe);
            myExtras.spinnyL.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);
            myExtras.spinnyR.setPower(coe);
            myExtras.spinnyR.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);
